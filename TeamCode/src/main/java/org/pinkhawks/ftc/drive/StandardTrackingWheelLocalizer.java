package org.pinkhawks.ftc.drive;
...
import org.pinkhawks.ftc.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double FORWARD_OFFSET = 6.80709; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.00510149;
    public static double Y_MULTIPLIER = 0.98159465;
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        rearEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rearLeft"));
