...
@Autonomous(name="RedAutos", group="Auto")
public class RedAutos extends LinearOpMode {
    ...
    private Trajectory leftTraj0, leftTraj1, leftTraj2, leftTraj3, leftTraj4, leftTraj5, leftTraj6;
    private Trajectory centerTraj0, centerTraj1, centerTraj2, centerTraj3, centerTraj4;
    private Trajectory rightTraj0, rightTraj1, rightTraj2, rightTraj3, rightTraj4, rightTraj5, rightTraj6;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        centerTraj2 = drive.trajectoryBuilder(centerTraj1.end())
                .lineToLinearHeading(new Pose2d(45,-13, Math.toRadians(8)))
                .build();
        ...
        rightTraj4 = drive.trajectoryBuilder(rightTraj3.end())
                .lineToLinearHeading(new Pose2d(45,-20, Math.toRadians(355)))
                .build();
        ...
        if (telemetryTfod() > 0 && telemetryTfod() < 200) {
            ...
            drive.followTrajectory(rightTraj0);
            claw.groundPos();
