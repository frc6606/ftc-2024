...
@Autonomous(name="ValkyriesAutoRight", group="Auto")
public class ValkyriesAuto extends LinearOpMode {

    private final SubsystemManager subsystemManager = new SubsystemManager();

    private Trajectory traj1, traj2, traj3, traj4, traj5, traj6, traj7;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        traj1 = drive.trajectoryBuilder(startpose)
                .lineToLinearHeading(new Pose2d(-10,18, Math.toRadians(178)))
                .build();
        ...
        /*traj7 = drive.trajectoryBuilder(traj6.end(), true)
                .lineToLinearHeading(new Pose2d(-25,40, Math.toRadians(178)))
                .build();
*/
